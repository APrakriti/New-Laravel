...
@section('title', 'Avia Club Nepal')
@section('meta_tags', 'Avia Club Nepal')
@section('meta_description', 'Avia Club Nepal ')
                ...
                <div class="col l12 m12 s12">
                    <div class="body_content">
                        <div class="breadcrumb-wrapper">
                            ...
                            <a href="#!" class="breadcrumb">Avia Club Nepal Inquiry</a>
                        </div>
                        <div class="sub_title mgb25">
                            <h2>Avia Club Nepal Online Inquiry</h2>
                        </div>
                            ...
                            <div class="col l8 m8 s12">
                                <form action="" name="bookingForm" method="POST">
                                    <div class="form_wrap">
                                        ...
                                        <div class="row">
                                            <div class="col l12 m12 s12">
                                                <div class="inner_head">Inquiry Details</div>
                                            </div>
                                            <div class="col l6 m6 s12">
                                                <div class="input-field ">
                                                    <input type="text" disabled value="Avia Club Nepal"
                                                           id="disabled" name="heading" class="validate">
                                                    <input type="hidden" value="Avia Club Nepal" id="disabled"
                           ...
                           <div class="col l6 m6 s12">
                            ...
                            <div class="col l4 m4 s12">
                                <div class="box related_trip_wrap">
                                    <div class="inner_head">Popular Packages</div>
                                    <div class="list">
                                        <ul>
