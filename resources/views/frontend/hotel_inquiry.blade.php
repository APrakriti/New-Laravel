...
@section('title', 'Hotel Inquiry')
@section('meta_tags', 'Hotel Inquiry')
@section('meta_description', 'Hotel Inquiry')
                ...
                <div class="col l12 m12 s12">
                    <div class="body_content">
                        <div class="breadcrumb-wrapper">
                            ...
                            <a href="#!" class="breadcrumb">Hotel Inquiry</a>
                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col l6 m6 s12">
                                                <div class="input-field ">
                                                    <select name="number_of_rooms" id="number_of_rooms" class="browser-default">
                                                        <option selected="" value="">No of Rooms</option>
                                                        @for ($i = 1; $i <= 100; $i++)
