...
@section('footer_js')
  ...
  $(document).ready(function() {
    ...
    $('#contentEditForm').formValidation({
        framework: 'bootstrap',
        icon: {
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
            <form role="form" id="contentEditForm" name="contentEditForm" action="" method="post" enctype="multipart/form-data">
              <div class="box-body">                
                <div class="form-group col-md-6">
                  <label for="exampleInputContent">Content Name *</label>
                  <input type="text" class="form-control" id="heading" name="heading" value="{{ $content->heading }}" placeholder="Enter content name">
                </div>                         
              </div>
              <!-- /.box-body -->
              ...
              <div class="box-body">
                <div class="form-group col-md-12">
                  ...
                  <textarea id="description" name="description" rows="10" cols="80">{!! $content->description !!}</textarea>
                  </div>                               
              </div>
              ...
              <div class="box-body">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="title" name="title" value="{{ $content->title }}" placeholder="Enter content title">
                </div>                               
              </div>
              ...
              <div class="box-body">
                <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" id="meta_tags" name="meta_tags" value="{{ $content->meta_tags }}" placeholder="Enter meta tags">
                </div>                               
              </div>
              ...
              <div class="box-body">
                <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" id="meta_description" name="meta_description" value="{{ $content->meta_description }}" placeholder="Enter meta description">
                </div>                               
              </div>
                ...
                <div class="form-group col-md-12">
                  ...
                  <div class="fileupload-new thumbnail">
                    @if(file_exists('uploads/contents/'.$content->attachment) && $content->attachment!='')
                      <img src="{{ asset('uploads/contents/'.$content->attachment) }}" alt="" id="upload-preview" >
                    @else
                  ...
                  @if(file_exists('uploads/contents/'.$content->attachment) && $content->attachment!='')
                    <a href="javascript:void(0)" class="delete-attachment" id="{{ $content->id }}">Delete Attachment</a>                             
                  @endif
              </div>
              ...
              <div class="box-body">
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" name="show_footer">
                    <option value="0" <?php echo ($content->show_footer == '0')? 'selected="selected"' : '' ?> >No</option>
                    <option value="1" <?php echo (($content->show_footer == '1' || $content->show_footer == '')? 'selected="selected"' : '') ?> >Yes</option>
                  </select>
                </div>
                <div class="form-group col-md-6">
                  <label for="exampleInputContent">Published</label>
                  <select class="form-control" name="is_active">
                    <option value="0" <?php echo ($content->is_active == '0')? 'selected="selected"' : '' ?> >No</option>
                    <option value="1" <?php echo (($content->is_active == '1' || $content->is_active == '')? 'selected="selected"' : '') ?> >Yes</option>
                  </select>
                </div>                              
              </div>
