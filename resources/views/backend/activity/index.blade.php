            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">
                            <a href="{{ route('admin.activity.add') }}" class="btn btn-block btn-primary"><span
                                ...
                                <tr id="activity_{{ $activity->id }}">
                                    ...
                                    <td>
                                        @if($activity->is_active == 1)
                                            <a href="javascript:void(0)" class="change-status" id="{{ $activity->id }}"
                                               title="Change Status"><i class="fa fa-check-square-o"></i></a>
                                        @else
                                            <a href="javascript:void(0)" class="change-status" id="{{ $activity->id }}"
                                               title="Change Status"><i class="fa fa-minus-circle"></i></a>
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0)" class="delete" id="{{ $activity->id }}"
