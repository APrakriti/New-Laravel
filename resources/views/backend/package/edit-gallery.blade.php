...
@section('dynamicdata')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ route('admin.package.galleries', $gallery->package->id) }}">Galleries
                    : {{ $gallery->package->heading }}</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" id="galleryEditForm" name="galleryEditForm" action="" method="post"
                          enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group col-md-6">
                                <label for="exampleInputGallery">Gallery caption *</label>
                                <input type="text" class="form-control" id="caption" name="caption"
                                       value="{{ $gallery->caption }}" placeholder="Enter caption">
                            </div>
                        </div>
                        <!-- /.box-body -->
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="fileupload-new thumbnail">
                                    @if(file_exists('uploads/gallery/'.$gallery->attachment) && $gallery->attachment!='')
                                        <img src="{{ asset('uploads/gallery/'.$gallery->attachment) }}" alt=""
                                             id="upload-preview">
                                    @else
                        ...
                        <div class="box-body">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="is_active">
                                    <option value="0" <?php echo ($gallery->is_active == '0') ? 'selected="selected"' : '' ?> >
                                        No
                                    </option>
                                    <option value="1" <?php echo(($gallery->is_active == '1' || $gallery->is_active == '') ? 'selected="selected"' : '') ?> >
                                        Yes
                                    </option>
                                </select>
                            </div>
