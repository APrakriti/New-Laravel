  ...
  $(document).ready(function() {
    ...
    $('.delete-attachment').click(function(){
      ...
      swal({
        ...
        $.ajax({
          type: "POST",
          url: "{{ route('admin.news.delete.attachment') }}",
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit News : {!! $news->heading !!}</h3>
            </div>
            <!-- /.box-header -->
            @include('layout.backend.alert')
            <!-- form start -->
            <form role="form" id="newsEditForm" name="newsEditForm" action="" method="post" enctype="multipart/form-data">
              <div class="box-body">                
                <div class="form-group col-md-6">
                  <label for="exampleInputContent">News Heading *</label>
                  <input type="text" class="form-control" id="heading" name="heading" value="{{ $news->heading }}" placeholder="Enter news heading">
                </div>                         
              </div>
              <!-- /.box-body -->
              ...
              <div class="box-body">
                <div class="form-group col-md-12">
                  ...
                  <textarea id="description" name="description" rows="10" cols="80">{!! $news->description !!}</textarea>
                  </div>                               
              </div>
              ...
              <div class="box-body">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="title" name="title" value="{{ $news->title }}" placeholder="Enter news title">
                </div>                               
              </div>
              ...
              <div class="box-body">
                <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" id="meta_tags" name="meta_tags" value="{{ $news->meta_tags }}" placeholder="Enter meta tags">
                </div>                               
              </div>
              ...
              <div class="box-body">
                <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" id="meta_description" name="meta_description" value="{{ $news->meta_description }}" placeholder="Enter meta description">
                </div>                               
              </div>
                ...
                <div class="form-group col-md-12">
                  ...
                  <div class="fileupload-new thumbnail">
                    @if(file_exists('uploads/news/'.$news->attachment) && $news->attachment!='')
                      <img src="{{ asset('uploads/news/'.$news->attachment) }}" alt="" id="upload-preview" >
                    @else
                  ...
                  @if(file_exists('uploads/news/'.$news->attachment) && $news->attachment!='')
                    <a href="javascript:void(0)" class="delete-attachment" id="{{ $news->id }}">Delete Attachment</a>                             
                  @endif
              </div>
              ...
              <div class="box-body">
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" name="is_active">
                    <option value="0" <?php echo ($news->is_active == '0')? 'selected="selected"' : '' ?> >No</option>
                    <option value="1" <?php echo (($news->is_active == '1' || $news->is_active == '')? 'selected="selected"' : '') ?> >Yes</option>
                  </select>
                </div>                              
              </div>
