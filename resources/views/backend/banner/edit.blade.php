    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <!-- form start -->
                    <form role="form" id="bannerEditForm" name="bannerEditForm" action="" method="post"
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="fileupload-new thumbnail">
                                    @if(file_exists('uploads/banners/'.$banner->attachment) && $banner->attachment!='')
                                        <img src="{{ asset('uploads/banners/'.$banner->attachment) }}" alt=""
                                             id="upload-preview">
                                    @else
                        ...
                        <div class="box-body">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="is_active">
                                    <option value="0" <?php echo ($banner->is_active == '0') ? 'selected="selected"' : '' ?> >
                                        No
                                    </option>
                                    <option value="1" <?php echo(($banner->is_active == '1' || $banner->is_active == '') ? 'selected="selected"' : '') ?> >
                                        Yes
                                    </option>
                                </select>
                            </div>
